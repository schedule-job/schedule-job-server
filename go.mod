module github.com/schedule-job/schedule-job-server
...
require (
	...
	github.com/schedule-job/schedule-job-authorization v1.0.0-alpha.2
	github.com/schedule-job/schedule-job-database v1.0.0-alpha.12
